...
_Channel _$ChannelFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_Channel',
  json,
  ($checkedConvert) {
    final val = _Channel(
      ...
      lang: $checkedConvert('lang', (v) => Language.fromString(v as String?)),
      ...
      commentsCrawledAt: $checkedConvert(
        'comments_crawled_at',
        (v) => v as String?,
      ),
