...
_VideoFull _$VideoFullFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_VideoFull',
  json,
  ($checkedConvert) {
    final val = _VideoFull(
      ...
      status: $checkedConvert(
        'status',
        (v) => VideoStatus.fromJson(v as String?),
      ),
      startScheduled: $checkedConvert('start_scheduled', (v) => v as String?),
      startActual: $checkedConvert('start_actual', (v) => v as String?),
      endActual: $checkedConvert('end_actual', (v) => v as String?),
      liveViewers: $checkedConvert('live_viewers', (v) => (v as num?)?.toInt()),
      ...
      channel: $checkedConvert(
        'channel',
        (v) =>
            v == null ? null : ChannelMin.fromJson(v as Map<String, dynamic>),
      ),
...
Map<String, dynamic> _$VideoFullToJson(
  _VideoFull instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'same_source_clips': instance.sameSourceClips.map((e) => e.toJson()).toList(),
};

const _$VideoTypeEnumMap = {VideoType.stream: 'stream', VideoType.clip: 'clip'};
